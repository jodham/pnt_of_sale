...
class manager_window:
    def __init__(self):
        ...
        self.side_frame.place(x=5, y=100, width=110, height=400)
        ...
        self.product_display_btn = Button(self.side_frame, text="Product", font="Aerial 10 bold")
        self.product_display_btn.place(x=1, y=1, height=60)
        self.product_display_btn = Button(self.side_frame, text="Product", font="Aerial 10 bold")
        self.product_display_btn.place(x=1, y=60, height=60)
        self.product_display_btn = Button(self.side_frame, text="Product", font="Aerial 10 bold")
        self.product_display_btn.place(x=1, y=120, height=60)
        self.product_display_btn = Button(self.side_frame, text="Product", font="Aerial 10 bold")
        self.product_display_btn.place(x=1, y=180, height=60)
